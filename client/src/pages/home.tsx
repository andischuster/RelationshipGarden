...
import { Heart, Sprout, Sun, Flower, Leaf, ShoppingCart, Shield, Star, Gift, TriangleAlert, Package, Users, Mail, HelpCircle, Instagram, Clover, Check, X } from 'lucide-react';
        ...
        <div className="mx-auto text-center w-full">
          ...
          <div className={`${isIntersecting['section-hero'] ? 'fade-in' : ''}`} style={{animationDelay: '0.6s'}}>
            ...
            <p className="text-sm text-deep-green/70 mt-3">
              <Package className="inline w-4 h-4 text-sunflower mr-2" />
